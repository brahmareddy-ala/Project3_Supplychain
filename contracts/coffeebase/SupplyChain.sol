...
contract SupplyChain is Ownable, FarmerRole, DistributorRole, ConsumerRole, RetailerRole {
  ...
  //onlyFarmer()
  {
    ...
    Item memory item = Item({upc: _upc, sku: sku, ownerID: msg.sender, originFarmerID: _originFarmerID, originFarmName: _originFarmName,
    originFarmInformation: _originFarmInformation, originFarmLatitude: _originFarmLatitude, originFarmLongitude: _originFarmLongitude,
    productID:sku+upc, productNotes: _productNotes, itemState: State.Harvested, productPrice:0, distributorID: address(0),retailerID: address(0),
    ...
    //onlyDistributor()
  {
    ...
    uint price = item.productPrice;
    item.distributorID = distributor;
    item.ownerID = distributor;
    item.itemState = State.Sold;
    items[_upc] = item;
    // Transfer money to farmer
    item.originFarmerID.transfer(price);
    // emit the appropriate event
    emit Sold(_upc);
  }
  ...
  function receiveItem(uint _upc) public
    ...
    address payable retailer = msg.sender;
